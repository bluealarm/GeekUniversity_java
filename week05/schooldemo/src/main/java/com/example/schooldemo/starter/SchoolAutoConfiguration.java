...
import com.example.schooldemo.starter.MySchool;
...
@EnableConfigurationProperties(com.example.schooldemo.starter.SchoolProperties.class)
@ConditionalOnProperty(prefix = "school", value = "enabled", havingValue = "true")
@PropertySource("classpath:application.properties")
public class SchoolAutoConfiguration {

    @Autowired
    private com.example.schooldemo.starter.SchoolProperties schoolProperties;
    ...
    public MySchool mySchool() {
        ...
        List<com.example.schooldemo.starter.Student> students = new ArrayList<>(studentIds.size());
        for (int i=0; i<studentIds.size(); i++) {
            students.add(new com.example.schooldemo.starter.Student(studentIds.get(i), studentNames.get(i)));
        }
